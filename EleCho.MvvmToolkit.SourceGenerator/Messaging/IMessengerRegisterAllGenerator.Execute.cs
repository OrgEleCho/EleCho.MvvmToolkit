...
using EleCho.MvvmToolkit.SourceGenerators.Messaging.Models;
...
partial class IMessengerRegisterAllGenerator
{
    ...
    private static class Execute
    {
        ...
        public static ImmutableArray<INamedTypeSymbol> GetInterfaces(INamedTypeSymbol typeSymbol)
        {
            ...
            {
                if (interfaceSymbol.HasFullyQualifiedMetadataName("EleCho.MvvmToolkit.Messaging.IRecipient`1"))
                {
        ...
        public static CompilationUnitSyntax GetSyntax(bool isDynamicallyAccessedMembersAttributeAvailable)
        {
            ...
            //
            // /// <summary>
            // /// A helper type with generated registration stubs for types implementing <see cref="global::EleCho.MvvmToolkit.Messaging.IRecipient{T}"/>.
            // /// </summary>
            ...
            attributes.Add(
                ...
                .WithOpenBracketToken(Token(TriviaList(
                    Comment("/// <summary>"),
                    Comment("/// A helper type with generated registration stubs for types implementing <see cref=\"global::EleCho.MvvmToolkit.Messaging.IRecipient{T}\"/>."),
            ...
            // namespace EleCho.MvvmToolkit.Messaging.__Internals
            // {
            //     <ATTRIBUTES>
            ...
            return
                ...
                NamespaceDeclaration(IdentifierName("EleCho.MvvmToolkit.Messaging.__Internals")).WithLeadingTrivia(TriviaList(
        ...
        public static CompilationUnitSyntax GetSyntax(RecipientInfo recipientInfo)
        {
            ...
            // public static global::System.Action<global::EleCho.MvvmToolkit.Messaging.IMessenger, object> CreateAllMessagesRegistrator(<RECIPIENT_TYPE> _)
            // {
            //     static void RegisterAll(global::EleCho.MvvmToolkit.Messaging.IMessenger messenger, object obj)
            //     {
            ...
            MethodDeclarationSyntax defaultChannelMethodDeclaration =
                MethodDeclaration(
                    GenericName("global::System.Action").AddTypeArgumentListArguments(
                        IdentifierName("global::EleCho.MvvmToolkit.Messaging.IMessenger"),
                    ...
                    .WithBody(Block(
                        ...
                        .AddParameterListParameters(
                            Parameter(Identifier("messenger")).WithType(IdentifierName("global::EleCho.MvvmToolkit.Messaging.IMessenger")),
            ...
            // [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
            // [global::System.Obsolete("This method is not intended to be called directly by user code")]
            // public static global::System.Action<global::EleCho.MvvmToolkit.Messaging.IMessenger, object, TToken> CreateAllMessagesRegistratorWithToken<TToken>(<RECIPIENT_TYPE> _)
            //     where TToken : global::System.IEquatable<TToken>
            // {
            //     static void RegisterAll(global::EleCho.MvvmToolkit.Messaging.IMessenger messenger, object obj, TToken token)
            //     {
            //         var recipient = (<INSTANCE_TYPE>)obj;
            //         <BODY>
            //     }
