...
public sealed class InvalidClassLevelNotifyPropertyChangedRecipientsAttributeAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(static context =>
        {
            ...
            if (context.Compilation.GetTypeByMetadataName("EleCho.MvvmToolkit.ComponentModel.NotifyPropertyChangedRecipientsAttribute") is not INamedTypeSymbol notifyPropertyChangedRecipientsAttributeSymbol ||
                context.Compilation.GetTypeByMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableRecipient") is not INamedTypeSymbol observableRecipientSymbol ||
                context.Compilation.GetTypeByMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableRecipientAttribute") is not INamedTypeSymbol observableRecipientAttributeSymbol)
            {
                return;
            }
