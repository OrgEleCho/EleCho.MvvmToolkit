...
using static EleCho.MvvmToolkit.SourceGenerators.Diagnostics.SuppressionDescriptors;
        ...
        foreach (Diagnostic diagnostic in context.ReportedDiagnostics)
        {
                ...
                attributeTarget.Identifier.IsKind(SyntaxKind.PropertyKeyword))
            {
                ...
                if (declaredSymbol is IFieldSymbol fieldSymbol &&
                    semanticModel.Compilation.GetTypeByMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservablePropertyAttribute") is INamedTypeSymbol observablePropertySymbol &&
