...
public sealed class ObservableRecipientGenerator : TransitiveMembersGenerator<ObservableRecipientInfo>
{
    ...
    public ObservableRecipientGenerator()
        : base("EleCho.MvvmToolkit.ComponentModel.ObservableRecipientAttribute")
    {
    }
    ...
    private protected override ObservableRecipientInfo? ValidateTargetTypeAndGetInfo(INamedTypeSymbol typeSymbol, AttributeData attributeData, Compilation compilation, out ImmutableArray<DiagnosticInfo> diagnostics)
    {
        ...
        if (typeSymbol.InheritsFromFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableRecipient"))
        {
        ...
        if (typeSymbol.InheritsAttributeWithFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableRecipientAttribute"))
        {
        ...
        if (!typeSymbol.InheritsFromFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableObject") &&
            !typeSymbol.HasOrInheritsAttributeWithFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableObjectAttribute") &&
            !typeSymbol.HasOrInheritsAttribute(static a =>
                a.AttributeClass?.HasFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.INotifyPropertyChangedAttribute") == true &&
        ...
        bool isObservableValidator = typeSymbol.InheritsFromFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableValidator");
