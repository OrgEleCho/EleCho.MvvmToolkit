...
partial class ObservableValidatorValidateAllPropertiesGenerator
{
    ...
    private static class Execute
    {
        ...
        {
            return typeSymbol.InheritsFromFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableValidator");
        }
        ...
        public static CompilationUnitSyntax GetSyntax(bool isDynamicallyAccessedMembersAttributeAvailable)
        {
            ...
            //
            // /// <summary>
            // /// A helper type with generated validation stubs for types deriving from <see cref="global::EleCho.MvvmToolkit.ComponentModel.ObservableValidator"/>.
            // /// </summary>
            ...
            attributes.Add(
                ...
                .WithOpenBracketToken(Token(TriviaList(
                    Comment("/// <summary>"),
                    Comment("/// A helper type with generated validation stubs for types deriving from <see cref=\"global::EleCho.MvvmToolkit.ComponentModel.ObservableValidator\"/>."),
