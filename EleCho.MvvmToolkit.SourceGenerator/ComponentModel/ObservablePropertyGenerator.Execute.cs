    ...
    internal static class Execute
    {
            ...
            out ImmutableArray<DiagnosticInfo> diagnostics)
        {
            ...
            if (hasAnyValidationAttributes &&
                !fieldSymbol.ContainingType.InheritsFromFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableValidator"))
            {
                builder.Add(
        ...
        private static bool IsTargetTypeValid(IFieldSymbol fieldSymbol, out bool shouldInvokeOnPropertyChanging)
        {
            ...
            bool isObservableObject = fieldSymbol.ContainingType.InheritsFromFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableObject");
            bool hasObservableObjectAttribute = fieldSymbol.ContainingType.HasOrInheritsAttributeWithFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableObjectAttribute");
            bool hasINotifyPropertyChangedAttribute = fieldSymbol.ContainingType.HasOrInheritsAttributeWithFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.INotifyPropertyChangedAttribute");
            ...
            in ImmutableArrayBuilder<DiagnosticInfo> diagnostics)
        {
            ...
            bool IsPropertyNameValidWithGeneratedMembers(string propertyName)
            {
                foreach (ISymbol member in fieldSymbol.ContainingType.GetAllMembers())
                {
                    if (member is IFieldSymbol otherFieldSymbol &&
                        ...
                        otherFieldSymbol.HasAttributeWithFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservablePropertyAttribute") &&
            ...
            if (attributeData.AttributeClass?.HasFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.NotifyPropertyChangedForAttribute") == true)
            {
            ...
            in ImmutableArrayBuilder<DiagnosticInfo> diagnostics)
        {
            ...
            bool IsCommandNameValid(string commandName, out bool shouldLookForGeneratedMembersToo)
            {
                ...
                if (fieldSymbol.ContainingType.GetAllMembers(commandName).OfType<IPropertySymbol>().FirstOrDefault() is IPropertySymbol propertySymbol)
                {
                    ...
                    if (propertySymbol.Type is INamedTypeSymbol typeSymbol &&
                        (typeSymbol.HasFullyQualifiedMetadataName("EleCho.MvvmToolkit.Input.IRelayCommand") ||
                         typeSymbol.HasInterfaceWithFullyQualifiedMetadataName("EleCho.MvvmToolkit.Input.IRelayCommand")))
                    {
            ...
            bool IsCommandNameValidWithGeneratedMembers(string commandName)
            {
                foreach (ISymbol member in fieldSymbol.ContainingType.GetAllMembers())
                {
                    if (member is IMethodSymbol methodSymbol &&
                        methodSymbol.HasAttributeWithFullyQualifiedMetadataName("EleCho.MvvmToolkit.Input.RelayCommandAttribute") &&
            ...
            if (attributeData.AttributeClass?.HasFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.NotifyCanExecuteChangedForAttribute") == true)
            {
        ...
        {
            if (fieldSymbol.ContainingType?.HasOrInheritsAttributeWithFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.NotifyPropertyChangedRecipientsAttribute") == true)
            {
                // If the containing type is valid, track it
                if (fieldSymbol.ContainingType.InheritsFromFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableRecipient") ||
                    fieldSymbol.ContainingType.HasOrInheritsAttributeWithFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableRecipientAttribute"))
                {
        ...
        {
            if (attributeData.AttributeClass?.HasFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.NotifyPropertyChangedRecipientsAttribute") == true)
            {
        ...
        {
            if (fieldSymbol.ContainingType?.HasOrInheritsAttributeWithFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.NotifyDataErrorInfoAttribute") == true)
            {
                // If the containing type is valid, track it
                if (fieldSymbol.ContainingType.InheritsFromFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.ObservableValidator"))
                {
        ...
        {
            if (attributeData.AttributeClass?.HasFullyQualifiedMetadataName("EleCho.MvvmToolkit.ComponentModel.NotifyDataErrorInfoAttribute") == true)
            {
                // Emit a diagnostic if the attribute is unnecessary
        ...
        public static MemberDeclarationSyntax GetPropertySyntax(PropertyInfo propertyInfo)
        {
            ...
            foreach (string propertyName in propertyInfo.PropertyChangingNames)
            {
                ...
                //
                // OnPropertyChanging(global::EleCho.MvvmToolkit.ComponentModel.__Internals.__KnownINotifyPropertyChangingArgs.<PROPERTY_NAME>);
                setterStatements.Add(
                    ExpressionStatement(
                        InvocationExpression(IdentifierName("OnPropertyChanging"))
                        .AddArgumentListArguments(Argument(MemberAccessExpression(
                            SyntaxKind.SimpleMemberAccessExpression,
                            IdentifierName("global::EleCho.MvvmToolkit.ComponentModel.__Internals.__KnownINotifyPropertyChangingArgs"),
            ...
            foreach (string propertyName in propertyInfo.PropertyChangedNames)
            {
                // This code generates a statement as follows:
                //
                // OnPropertyChanging(global::EleCho.MvvmToolkit.ComponentModel.__Internals.__KnownINotifyPropertyChangedArgs.<PROPERTY_NAME>);
                setterStatements.Add(
                    ExpressionStatement(
                        InvocationExpression(IdentifierName("OnPropertyChanged"))
                        .AddArgumentListArguments(Argument(MemberAccessExpression(
                            SyntaxKind.SimpleMemberAccessExpression,
                            IdentifierName("global::EleCho.MvvmToolkit.ComponentModel.__Internals.__KnownINotifyPropertyChangedArgs"),
                            IdentifierName(propertyName))))));
            }
            ...
            ImmutableArray<string> names)
        {
            ...
            // #nullable enable
            // namespace EleCho.MvvmToolkit.ComponentModel.__Internals
            // {
            //     /// <summary>
            //     /// A helper type providing cached, reusable <see cref="<ARGS_TYPE_NAME>"/> instances
            //     /// for all properties generated with <see cref="global::EleCho.MvvmToolkit.ComponentModel.ObservablePropertyAttribute"/>.
            //     /// </summary>
            //     [global::System.CodeDom.Compiler.GeneratedCode("...", "...")]
            ...
            return
                ...
                NamespaceDeclaration(IdentifierName("EleCho.MvvmToolkit.ComponentModel.__Internals")).WithLeadingTrivia(TriviaList(
                ...
                ClassDeclaration(containingTypeName).AddModifiers(
                    ...
                    Token(SyntaxKind.StaticKeyword)).AddAttributeLists(
                        ...
                        .WithOpenBracketToken(Token(TriviaList(
                            ...
                            Comment("/// for all properties generated with <see cref=\"global::EleCho.MvvmToolkit.ComponentModel.ObservablePropertyAttribute\"/>."),
