...
using EleCho.MvvmToolkit.SourceGenerators.Input.Models;
    ...
    internal static class Execute
    {
        ...
        public static ImmutableArray<MemberDeclarationSyntax> GetSyntax(CommandInfo commandInfo)
        {
            ...
            if (commandInfo.AllowConcurrentExecutions && !commandInfo.FlowExceptionsToTaskScheduler)
            {
                commandCreationArguments.Add(
                    Argument(MemberAccessExpression(
                        ...
                        IdentifierName("global::EleCho.MvvmToolkit.Input.AsyncRelayCommandOptions"),
            ...
            if (commandInfo.IncludeCancelCommand)
            {
                ...
                // [global::System.CodeDom.Compiler.GeneratedCode("...", "...")]
                // [global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
                // public global::System.Windows.Input.ICommand <CANCEL_COMMAND_PROPERTY_NAME> => <CANCEL_COMMAND_FIELD_NAME> ??= global::EleCho.MvvmToolkit.Input.IAsyncRelayCommandExtensions.CreateCancelCommand(<COMMAND_PROPERTY_NAME>);
                        ...
                        ArrowExpressionClause(
                            AssignmentExpression(
                                ...
                                InvocationExpression(
                                    MemberAccessExpression(
                                        SyntaxKind.SimpleMemberAccessExpression,
                                        IdentifierName("global::EleCho.MvvmToolkit.Input.IAsyncRelayCommandExtensions"),
        ...
        private static bool IsCommandDefinitionUnique(IMethodSymbol methodSymbol, in ImmutableArrayBuilder<DiagnosticInfo> diagnostics)
        {
            ...
            foreach (ISymbol symbol in methodSymbol.ContainingType.BaseType?.GetAllMembers(methodSymbol.Name) ?? Enumerable.Empty<ISymbol>())
            {
                if (symbol is IMethodSymbol otherSymbol &&
                    otherSymbol.HasAttributeWithFullyQualifiedMetadataName("EleCho.MvvmToolkit.Input.RelayCommandAttribute"))
                {
                    diagnostics.Add(
            ...
            out ImmutableArray<string> delegateTypeArgumentsWithNullabilityAnnotations)
        {
            ...
            {
                commandInterfaceType = "global::EleCho.MvvmToolkit.Input.IRelayCommand";
                commandClassType = "global::EleCho.MvvmToolkit.Input.RelayCommand";
            ...
            if (methodSymbol.ReturnType.HasOrInheritsFromFullyQualifiedMetadataName("System.Threading.Tasks.Task"))
            {
                ...
                {
                    commandInterfaceType = "global::EleCho.MvvmToolkit.Input.IAsyncRelayCommand";
                    commandClassType = "global::EleCho.MvvmToolkit.Input.AsyncRelayCommand";
            ...
            out bool allowConcurrentExecutions)
        {
            ...
            if (commandClassType is "global::EleCho.MvvmToolkit.Input.AsyncRelayCommand")
            {
                return true;
            }
            else
            ...
            foreach (ISymbol memberSymbol in containingType.GetAllMembers())
            {
                ...
                if (memberSymbol is IFieldSymbol &&
                    !attributes.Any(static a => a.AttributeClass?.HasFullyQualifiedMetadataName(
                        "EleCho.MvvmToolkit.ComponentModel.ObservablePropertyAttribute") == true))
                {
                    continue;
                }
