...
internal static class IncrementalGeneratorInitializationContextExtensions
{
        ...
        Func<GeneratorAttributeSyntaxContextWithOptions, CancellationToken, T> transform)
    {
        ...
        IncrementalValuesProvider<GeneratorAttributeSyntaxContext> syntaxContext = context.SyntaxProvider.ForAttributeWithMetadataName<GeneratorAttributeSyntaxContext>(
