...
using EleCho.MvvmToolkit.Messaging.Internals;

namespace EleCho.MvvmToolkit.Messaging;
...
public static partial class IMessengerExtensions
{
    ...
    public static void RegisterAll(this IMessenger messenger, object recipient)
    {
        ...
        {
            if (recipientType.Assembly.GetType("EleCho.MvvmToolkit.Messaging.__Internals.__IMessengerExtensions") is Type extensionsType &&
